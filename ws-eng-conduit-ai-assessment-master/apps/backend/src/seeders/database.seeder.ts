...
export class DatabaseSeeder extends Seeder {
  @InjectRepository(Article)
    public articleRepository: EntityRepository<Article>;

  async run(em: EntityManager): Promise<void> {
    var tags = this.getTags(em);
  ...
  public getTags(em: EntityManager): Record<string, Tag> {
    return {
